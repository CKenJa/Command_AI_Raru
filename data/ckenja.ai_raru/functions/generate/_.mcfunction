...
#           inputされる行列のサイズ
#   storage ckenja.ai_raru.__temp__:generate __input__
#       model
...
#
# @output
#   storage ckenja.ai_raru.__temp__:generate __output__.model
#       生成したモデル
#
# @public

data modify storage ckenja.ai_raru.__temp__:generate model set from storage ckenja.ai_raru.__temp__:generate __input__.model
