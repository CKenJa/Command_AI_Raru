...
execute if score hold= ckenja.ai_raru.arr_math.main matches ..-1 run scoreboard players set temp= ckenja.ai_raru.arr_math.main -1
execute if score hold= ckenja.ai_raru.arr_math.main matches 0.. run scoreboard players set temp= ckenja.ai_raru.arr_math.main 0
execute if score hold= ckenja.ai_raru.arr_math.main matches ..-1 run scoreboard players operation hold= ckenja.ai_raru.arr_math.main += base= ckenja.ai_raru.arr_math.main
...
#loop condition
execute unless data storage ckenja.ai_raru.arr_math:main {v1:{num:["end"]},v2:{num:["end"]}} run function ckenja.ai_raru.arr_math:ops/sub_cur