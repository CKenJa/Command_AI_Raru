...
execute if data storage ckenja.ai_raru.arr_math:main out{result:2} run data modify storage ckenja.ai_raru.__temp__:calc matrix.output.fpa set from storage ckenja.ai_raru.arr_math:main out.result
execute unless data storage ckenja.ai_raru.arr_math:main out{result:2} run data modify storage ckenja.ai_raru.__temp__:calc matrix.output.fpa set value {dec:0,num:[0],pol:1,base:10}
