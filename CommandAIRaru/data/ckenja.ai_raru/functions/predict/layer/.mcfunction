#> ckenja.ai_raru:predict/layer/
#
#レイヤーループ
#
# @within function ckenja.ai_raru:predict/module/

say layer

function ckenja.ai_raru:predict/node/
...
execute if data storage ckenja.ai_raru.__temp__:predict model.module[-1].layer[-1] run function ckenja.ai_raru:predict/layer/
