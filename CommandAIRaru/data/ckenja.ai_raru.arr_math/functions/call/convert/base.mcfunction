...
data modify storage ckenja.ai_raru.arr_math:main dc.out set value {num:[],base:10,dec:0,pol:1}
...
execute if score v1base= ckenja.ai_raru.arr_math.main = v2base= ckenja.ai_raru.arr_math.main run function ckenja.ai_raru.arr_math:ops/do_dc
