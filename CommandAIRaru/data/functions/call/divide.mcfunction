...
#writing from input
execute unless data storage ckenja.ai_raru.arr_math:main dc run data modify storage ckenja.ai_raru.arr_math:main v1 set from storage ckenja.ai_raru.arr_math:in var1
data modify storage ckenja.ai_raru.arr_math:main v2 set from storage ckenja.ai_raru.arr_math:in var2
data modify storage ckenja.ai_raru.arr_math:main out set value {num:[],dec:0,base:0,pol:1,rem:[]}
...
execute if score v1base= ckenja.ai_raru.arr_math.main = v2base= ckenja.ai_raru.arr_math.main run function ckenja.ai_raru.arr_math:ops/div_check
